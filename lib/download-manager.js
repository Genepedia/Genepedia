/**
 * Download Manager — reusable download/export helpers for Genipedia pages.
 *
 * API:
 *   await window.GenipediaDownloads.handleDownload(type, { getContentEl, getTitle })
 *
 * Parameters:
 ...
 *   window.GenipediaDownloads?.handleDownload('pdf', {
 ...
 *     window.GenipediaDownloads?.handleDownload('png', {
...
(function (window, document) {
    ...
    window.GenipediaDownloads = Manager;
})(window, document);
