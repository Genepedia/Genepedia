/**
 * Download Manager — reusable download/export helpers for Genepedia pages.
 *
 * API:
 *   await window.GenepediaDownloads.handleDownload(type, { getContentEl, getTitle })
 *
 * Parameters:
 ...
 *   window.GenepediaDownloads?.handleDownload('pdf', {
 ...
 *     window.GenepediaDownloads?.handleDownload('png', {
...
(function (window, document) {
    ...
    window.GenepediaDownloads = Manager;
})(window, document);
